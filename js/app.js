...
function consultarAPI(ciudad, pais ) {
    ...
    const appId = 'b109e4d19d6fc90673c18f86433b83a0';//Generar la API Key personal de cada uno en la página: openweathermap.org
...
function mostrarClima(datos) {
  ...
  tempMaxima.classList.add('text-xl', 'text-black')


  const tempMinima = document.createElement('p');
  tempMinima.innerHTML = `Min: ${min} &#8451;`;
  tempMinima.classList.add('text-xl', 'text-black')
